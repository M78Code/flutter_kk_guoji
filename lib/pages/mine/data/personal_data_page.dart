                ...
                children: [
                  ...
                  Expanded(child: Container(
                    ...
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        const Text("获得彩金", style: TextStyle(color: Colors.white, fontSize: 12),),
                        Obx((){
                        ...
                        return  Container(
                          ...
                          child:  Row(
                              ...
                              children: [
                                ...
                                Expanded(child: KKProgressbar(value: double.parse(data["total_bet"])<=0?0.0:double.parse(data["total_bet"])/100000.0, width: 111, height: 7, outerDecoration: BoxDecoration(
