...
class KKGamesMenuWidget extends GetView<GamesLogic> {
  ...
  GestureDetector buildItem(String name, double opacity, GestureTapCallback tap, bool arrowVisible) {
    return GestureDetector(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
            // Image.asset(item.first, width: 44.w, height: 63.w,),
            Text(name,style: TextStyle(color: Colors.white),).height(63.w),
