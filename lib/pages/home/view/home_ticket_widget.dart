    ...
    return Column(
      children: [
        ...
        SizedBox(
          ...
          child: ticketList.isEmpty? Container():Swiper(
            autoplayDisableOnInteraction:false,
            autoplay: true,
            itemCount: controller.ticketList.length, itemBuilder: (BuildContext context, int index) {
            return _buildGroupItem(controller.ticketList[index]);
          },
  ...
  Widget _buildGroupItem(List ticketGroup) {
    return Obx(() => Column(
      children: ticketGroup.asMap().entries.map((e) {
        ...
        // String periodsNumber = currentInfo["periodsNumber"].toString();
        ...
        //       mainAxisAlignment: MainAxisAlignment.center,
        //       crossAxisAlignment: CrossAxisAlignment.center,
        //       children: playList.asMap().entries.map((e){
