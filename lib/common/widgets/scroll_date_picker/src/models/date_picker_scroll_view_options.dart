...
class ScrollViewDetailOptions {
  const ScrollViewDetailOptions({
    ...
    this.selectedTextStyle =
        const TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: Color(0xA8FFFFFF)),
    this.textStyle =
        const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Color(0x33FFFFFF)),
  });
