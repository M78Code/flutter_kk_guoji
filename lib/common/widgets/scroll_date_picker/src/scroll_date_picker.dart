...
import 'package:kkguoji/common/widgets/scroll_date_picker/src/widgets/date_scroll_view.dart';
...
class _ScrollDatePickerState extends State<ScrollDatePicker> {
  ...
  List<Widget> _getScrollDatePicker() {
    ...
    var textDay = Text('日', style: TextStyle(color: Color(0xFF687083), fontWeight: FontWeight.w400, fontSize: 12.sp),);
    var textMonth = Text('月', style: TextStyle(color: Color(0xFF687083), fontWeight: FontWeight.w400, fontSize: 12.sp),);

    switch (widget.locale.languageCode) {
      case zh:
      case ko:
        return [ _dayScrollView,textDay, _monthScrollView,textMonth, _yearScrollView,];
      case vi:
      case id:
      case th:
      case de:
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: [
                        ...
                        widget.options.backgroundColor.withOpacity(0.1),
                      ],
                    ),
                  ),
                ),
